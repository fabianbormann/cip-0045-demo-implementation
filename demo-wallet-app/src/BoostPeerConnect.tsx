...
import type { Paginate } from '@fabianbormann/cardano-peer-connect/types';

export class BoostPeerConnect extends CardanoPeerConnect {
  apiVersion: string = '1.0.0';
  name: string = 'boostwallet';
  icon: string =
  ...
  async getRewardAddresses() {
    return ['e1820506cb0ce54ae755b2512b6cf31856d7265e8792cb86afc94e0872'];
  }
  async getNetworkId() {
    return -1;
  }
  ...
  async getCollateral(params?: { amount?: string | undefined } | undefined) {
    return [];
  }
  async getBalance() {
    return '';
